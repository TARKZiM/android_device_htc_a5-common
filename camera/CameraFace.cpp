...
class CameraFace {
    ...
    int initialize(face_config_type* a);
    ...
    std::string getParameters(android::CameraParameters&) const;
    int processPreview(unsigned char*a, android::CameraParameters&, int c, faceBeauty_config_type* d, android::face_info_t* e, multi_face_info_t* f, camera_frame_metadata *g);
...
CameraFace::~CameraFace() { }
int CameraFace::initialize(face_config_type* a) { return 0; }
...
std::string CameraFace::getParameters(android::CameraParameters&) const { return ""; }
int CameraFace::processPreview(unsigned char*a, android::CameraParameters&, int c, faceBeauty_config_type* d, android::face_info_t* e, multi_face_info_t* f, camera_frame_metadata *g) { return 0; }
